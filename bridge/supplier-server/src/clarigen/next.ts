...
export const deployments = {
  ...
  restrictedTokenTrait: {
    ...
    testnet: 'ST02D2KP0630FS1BCJ7YM4TYMDH6NS9QKR0B57R3.restricted-token-trait',
    mainnet: 'SP02D2KP0630FS1BCJ7YM4TYMDH6NS9QKTNCZR00.restricted-token-trait',
  },
  bridge: {
    devnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.bridge',
    simnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.bridge',
    testnet: 'ST02D2KP0630FS1BCJ7YM4TYMDH6NS9QKR0B57R3.degen-bridge-testnet-v3',
    mainnet: 'SP02D2KP0630FS1BCJ7YM4TYMDH6NS9QKTNCZR00.degen-bridge-testnet-v3',
  },
  ftTrait: {
    devnet: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.ft-trait',
    simnet: 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.ft-trait',
    testnet: 'ST02D2KP0630FS1BCJ7YM4TYMDH6NS9QKR0B57R3.ft-trait',
    mainnet: 'SP02D2KP0630FS1BCJ7YM4TYMDH6NS9QKTNCZR00.ft-trait',
  ...
  wrappedBitcoin: {
    ...
    testnet: 'ST02D2KP0630FS1BCJ7YM4TYMDH6NS9QKR0B57R3.Wrapped-Bitcoin',
    mainnet: 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin', // AlexGo
  },
  clarityBitcoin: {
    ...
    testnet: 'ST02D2KP0630FS1BCJ7YM4TYMDH6NS9QKR0B57R3.clarity-bitcoin',
...
export const simnetDeployment = [
  {
    ...
    file: '.clarinet/SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.ft-trait.clar',
  },
  {
    identifier: 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.restricted-token-trait',
    file: '.clarinet/SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.restricted-token-trait.clar',
  },
  {
    identifier: 'SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin',
    file: '.clarinet/SP3DX3H4FEYZJZ586MFBS25ZW3HZDMEW92260R2PR.Wrapped-Bitcoin.clar',
  },
  {
    identifier: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.test-utils',
    file: 'contracts/test/test-utils.clar',
  },
  {
    identifier: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.clarity-bitcoin',
    file: 'contracts/test/clarity-bitcoin.clar',
  },
  { identifier: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.bridge', file: 'contracts/bridge.clar' },
  {
    identifier: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.supplier-wrapper',
    file: 'contracts/supplier-wrapper.clar',
  },
];

export const accounts = {
  deployer: { address: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM', balance: 100000000000000 },
  operator: { address: 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5', balance: 100000000000000 },
  swapper: { address: 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG', balance: 100000000000000 },
